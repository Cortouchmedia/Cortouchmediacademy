  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      <div>
        ...
        <p className="text-brand-muted mt-1 text-sm lg:text-base">Ready to continue your learning journey?</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <section className="lg:col-span-2">
            ...
            <p className="text-brand-muted mb-6 text-sm lg:text-base">Based on your interests and learning history, we think you'll love these courses.</p>
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                {recommendedCourses.length > 0 ? (
                  ...
                  <div className="col-span-full p-8 bg-brand-surface rounded-xl border border-dashed border-slate-300 text-center">
                    <p className="text-brand-muted italic text-sm">No recommendations available at the moment. Explore our catalog to find your next course!</p>
                  </div>
                )}
             </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-brand-surface rounded-lg p-4 lg:p-6 space-y-4 shadow-sm border border-slate-200/50">
