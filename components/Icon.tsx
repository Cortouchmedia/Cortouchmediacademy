...
const iconPaths: { [key: string]: React.ReactNode } = {
  ...
  chartLine: <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5h3.75M3 16.5v-3.75M3 16.5l3.75-3.75m15 3.75H21M21 16.5v-3.75M21 16.5l-3.75-3.75M12 3v3.75M12 3h3.75M12 3L8.25 6.75M12 21v-3.75M12 21h-3.75M12 21l3.75-3.75" />,
  ...
  enrollment: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />,
  ...
  pieChart: <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />,
  ...
  students: <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.512 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m7.512 2.72a8.97 8.97 0 01-7.512 0m7.512 2.72l-7.512-2.72M3 21v-4.675A4.5 4.5 0 017.5 12h9a4.5 4.5 0 014.5 4.325V21" />,
...
export const Icon: React.FC<IconProps> = ({ name, className, strokeWidth = 2, ...props }) => {
  ...
  if (!pathData) {
    // Fallback icon - shows a warning circle
    return (
  ...
  // Icons that should have fill instead of stroke
  const fillIcons = ['google', 'facebook', 'instagram', 'twitter', 'xLogo', 'linkedin', 'tiktok'];
